...
## Implementación del 3 de septiembre de 2026

### Lectores activos sin asignación

Se implementaron dos presentaciones de la misma información: una para todas las personas en **Cobertura** y otra de apoyo administrativo en **Estadísticas**.
...
- Los lectores inactivos no forman parte de este grupo, porque no están disponibles para planificar.
- Se incluyen tanto lectores activos normales como lectores activos configurados como **Solo suplente**. La interfaz distingue claramente ambas condiciones.
- El resultado se recalcula al cambiar el mes. Una persona puede estar sin asignación en un mes y participar en otro.
- **Sin asignación** es un dato derivado, no una casilla nueva ni una propiedad adicional guardada en MongoDB.
- No se necesita una colección ni una ruta de escritura nueva: se usan los lectores, las misas y las asignaciones que la aplicación ya carga para el mes seleccionado.

#### Presentación pública en Cobertura

- Se conserva exactamente la consulta anterior de **Cobertura**: selección de misa, totales, grupos de disponibilidad y búsqueda de personas.
- Inmediatamente debajo del campo **Buscar lector** aparece un acordeón titulado **Lectores sin asignación**.
- El acordeón aparece **abierto inicialmente** cada vez que se carga la vista.
- Es visible para todas las personas tanto en `/cobertura.html` como, por compartir la vista, en `/admin/cobertura.html`.
- Para cada lector se muestra el nombre, una etiqueta **Lector normal** o **Solo suplente**, y las misas que tiene como preferidas.
- El campo **Buscar lector** también filtra las personas del nuevo acordeón. El contador de su cabecera conserva el total de lectores sin asignación del mes, aunque una búsqueda deje visibles solo algunas personas.
- Esta consulta es exclusivamente de lectura y no incluye botones para editar lectores o crear asignaciones.
- No muestra teléfonos, contraseñas, notas administrativas ni datos de lectores inactivos.
- Si no hay personas sin asignación, el acordeón permanece visible y muestra **Todos los lectores activos tienen asignación este mes**.

#### Presentación administrativa en Estadísticas

- Además de aparecer en Cobertura administrativa, existe un grupo dedicado dentro de **Estadísticas → Directorio de lectores**.
- Está debajo de los cuatro indicadores del Directorio y antes de los acordeones **Activos normales**, **Solo suplentes** e **Inactivos**.
- Usa el selector de mes propio del Directorio y se actualiza junto con sus indicadores.
- Se presenta como un acordeón **Lectores sin asignación**, abierto inicialmente.
- Dentro del acordeón se separan visualmente los lectores normales, que pueden ser titulares o suplentes, de quienes están configurados exclusivamente como suplentes.
- Cada persona muestra su nombre y sus misas preferidas, manteniendo el Directorio como una consulta de solo lectura. La edición continúa realizándose desde **Lectores** y la planificación desde **Asignaciones**.
- Si todos los lectores activos participan durante el mes, muestra el mismo estado vacío informativo de la presentación pública.

Las dos presentaciones ya están implementadas. Se actualizaron `public/app.html`, `private/js/common-vistas.js`, `public/estadisticas.html`, `private/js/estadisticas.js` y `private/styles.css`.

### Verificación

- La vista pública se cargó con Chrome contra `http://localhost:3000/cobertura.html`, con la CSP real del servidor.
- Para septiembre de 2026 mostró cinco lectores sin asignación, incluidos lectores normales y de solo suplencia, con sus preferencias y el acordeón abierto inicialmente.
- Se comprobó visualmente que el bloque queda inmediatamente debajo de los controles de misa y búsqueda y antes del resumen de la misa seleccionada.
